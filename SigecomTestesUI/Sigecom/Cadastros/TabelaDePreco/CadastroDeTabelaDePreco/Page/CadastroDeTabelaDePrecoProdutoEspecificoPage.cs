    ...
    public class CadastroDeTabelaDePrecoProdutoEspecificoPage: ICadastroDeTabelaDePrecoPage
    {
        ...
        public void PreencherCamposDaTabela()
        {
            try
            {
                ...
                _driverService.DigitarNoCampoComTeclaDeAtalhoId(CadastroDeTabelaDePrecoModel.ElementoPesquisaDeProduto, CadastroDeTabelaDePrecoModel.NomeDoProdutoParaPesquisar, Keys.Enter);
            }
