namespace SigecomTestesUI.Sigecom.Cadastros.Pessoas.Colaborador.CadastroDeColaborador.Model
{
    public static class CadastroDeColaboradorModel
    {
        public static string BotaoMenu => "Cadastro";
        public static string BotaoSubMenu => "Colaboradores";
        public static string TelaCadastroColaborador => "Cadastro de colaboradores";
        ...
        public static string ElementoSexo => "cbxSexo";
        public static string ElementoEstadoCivil => "cbxEstadoCivil";
        public static string ElementoTipoContato => "cbxPessoaContatoTipo";
        public static string BotaoContato => "btnAddContato";

        public static string ElementoDataAdmissao => "txtDataAdmissao";
        public static string ElementoDataDesligamento => "txtDataDesligamento";
        public static string ElementoEmailFuncionario => "txtEmailFuncionario";
        public static string ElementoDiaPagamento => "txtDiaPagamento";
        public static string ElementoSalario => "txtSalario"; 
        public static string ElementoTelefoneFuncionario => "txtTelefoneFuncionario";
        public static string ElementoCargo => "txtCargo";
    }
}
