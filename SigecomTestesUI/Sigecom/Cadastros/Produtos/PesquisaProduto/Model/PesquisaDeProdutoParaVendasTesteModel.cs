...
{
    public class PesquisaDeProdutoParaVendasTesteModel
    {
        public static string NomeDoProduto => "PRODUTO PARA TESTAR VENDAS";
        ...
        public static string NomeFinalDoProduto => "PRODUTO PARA TESTAR VENDAS";
    }
}
