namespace SigecomTestesUI.Sigecom.Vendas.Condicional.LancarCondicional.Model
{
    public class CondicionalModel
    {
        ...
        public static string AcoesDaCondicional => "gridAcoes";
        ...
        public static string ElementoValorTotalParaPagarAoFaturar => "lblTotalPagar";
        public static string ElementoDeTaxaEntrega => "textEditTaxaEntrega";
        public static string ElementoDoComboDaTabelaDePreco => "cbxTabelaPreco";
        public static string BotaoAtalhosCondicional => ", Atalhos/Opções - F1";
        public static string AtalhoDeEditarClienteDaCondicional => ", [ F2 ] - Inserir cliente";
        ...
        public static string CampoDaGridDeValorTotalDaTelaDeConsultaDeCondicional => "Valor";
        public static string CampoDaGridDeCodigoDaTelaDeConsultaDeCondicional => "Código";
    }
}
