namespace SigecomTestesUI.Sigecom.Estoque.ManutencaoDeEstoque.Model
{
    public class AlteracaoEmMassaModel
    {
        ...
        public static string ElementoDaToggleDoFornecedor => "fornecedorToggleSwitch";
        public static string ElementoDoCampoDoLocal => "localTextEdit";
        public static string ElementoDaToggleDoLocal => "localToggleSwitch";
        public static string ElementoDoCampoDoAtivoDesativo => "ativoOuDesativadoComboBoxEdit";
        public static string ElementoDaToggleDoAtivoDesativo => "ativoOuDesativadoToggleSwitch";
    }
}
