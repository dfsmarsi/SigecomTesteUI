...
{
    public class PagarContaParcialComHaverPage:PageObjectModel
    {
        public PagarContaParcialComHaverPage(DriverService driver) : base(driver)
        {
        }
        ...
        public void RealizarFluxoPagarContaParcialComHaver()
        {
            // Arange
            ClicarNaOpcaoDoMenu();
